  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-nextpay" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-nextpay" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="nextpay_pin" value="<?php echo $nextpay_pin; ?>" placeholder="<?php echo $entry_pin; ?>" id="input-pin" class="form-control" />
              <?php if ($error_pin) { ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="developer">پشتیبانی</label>
            <div class="col-sm-10">
              <span id="developer" class="form-control"><a href="http://nextpay.ir/" title="نکست پی">نکست پی</a></span>
            </div>
          </div>
        </form>
      </div>
